...
describe('Handling slider inputs', () => {
    ...
    it('Image/carousal based sliders', () => {
        ...
        /*  Here, we don't have input range type sliders
           ...
           Also, we can direclty use buttons above to change the slide
    ...
    it('Different slider', () => {
        ...
        */
        ...
        cy.get('.ui-slider-range.ui-corner-all.ui-widget-header').invoke('attr', 'style', 'left: 14%; width: 84%;').then(() => {
